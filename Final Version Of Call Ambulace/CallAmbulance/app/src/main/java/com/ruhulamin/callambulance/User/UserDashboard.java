...
import com.ruhulamin.callambulance.LoginSignup.Login;
import com.ruhulamin.callambulance.R;
import com.ruhulamin.callambulance.User.Features.Hire;
import com.ruhulamin.callambulance.User.Features.Hospital;
...
public class UserDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    //Features
    ImageView payment_Btn, hire_Btn, btn_hospital,btn_call;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // HireAmbulance Hooks And Functions
        ...
        // Hospital Hooks And Functions
        btn_hospital = findViewById(R.id.btn_hospital);
        btn_hospital.bringToFront();
        btn_hospital.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent hospital = new Intent(UserDashboard.this, Hospital.class);
                startActivity(hospital);
            }
        });

        // Types Hooks And Functions
        btn_call = findViewById(R.id.btn_call);
        btn_call.bringToFront();
        btn_call.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent call = new Intent(UserDashboard.this, Types.class);
                startActivity(call);
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.nav_hospital:
                Intent hospital = new Intent(getApplicationContext(), Hospital.class);
                startActivity(hospital);
                break;
